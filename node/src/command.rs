...
fn load_spec(id: &str) -> std::result::Result<Box<dyn ChainSpec>, String> {
	Ok(match id {
		...
		"template-rococo" => Box::new(chain_spec::local_testnet_config(2000)),
		"2k" => Box::new(chain_spec::local_testnet_config(2000)),
		"3k" => Box::new(chain_spec::local_testnet_config(3000)),
